...
class Produto extends Component {
    render() { 
      ...
      <div className="row featurette">
        <div className="col">
          <img src="assets/img/home-gabinete-img-removebg-preview.png" alt="Prodigy" className="gabinete mob"  data-aos="fade-up"  data-aos-anchor-placement="top-center" data-aos-duration="1000"/>
        </div>
      </div>
      <div className="row featurette">
        ...
        <div className="col-md-5 order-md-2">
          <img src="assets/img/pc-yuri.png" alt="Prodigy" className="gabinete mob" data-aos="fade-up"  data-aos-anchor-placement="top-center" data-aos-duration="1000"/>
        </div>
      </div>
      <div className="row featurette">
        <hr className="featurette-divider"/>
        ...
        <div className="col-md-5 order-md-1">
          <img src="assets/img/img2.png" alt="Prodigy" className="gabinete mob" data-aos="fade-up"  data-aos-anchor-placement="top-center" data-aos-duration="1000"/>
        </div>
      </div>
    </div>
        );
