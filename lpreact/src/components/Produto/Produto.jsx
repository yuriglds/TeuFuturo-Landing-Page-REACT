...
class Produto extends Component {
    render() { 
      ...
      <div className="row featurette">
        <div className="col">
          <img src={require("../../assets/img/home-gabinete-img-removebg-preview.png")} alt="Prodigy" className="gabinete mob"  data-aos="fade-up"  data-aos-anchor-placement="top-center" data-aos-duration="1000"/>
        </div>
      </div>
      <div className="row featurette">
