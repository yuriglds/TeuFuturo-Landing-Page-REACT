        ...
        return (
            ...
            <div className="row featurette">
              <div className="col-md-7">
                <h1 className="featurette-heading fw-normal lh-1 upper title-hr titlee" data-aos="fade-right" data-aos-delay="200">Processador</h1>
              ...
              <div className="col-md-5" data-aos="fade-up"  data-aos-anchor-placement="top-center" data-aos-duration="1000">
                <img src={require("../../assets/img/cpu.png")} alt="Processador" className="mob animated"/>
              </div>
            </div>
            </div>
        );
